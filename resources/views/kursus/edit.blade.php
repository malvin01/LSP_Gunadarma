                  ...
                  <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                      <div class="col-span-6">
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama', $kursus->nama) }}"
                      ...
                      <div class="col-span-6">
                        ...
                        {{ $errors->has('keterangan') ? 'bg-red-50 border border-red-500 text-red-900 focus:ring-red-500 focus:border-red-500' : '' }}">{{ old('keterangan', $kursus->keterangan) }}</textarea>
                        @error('keterangan')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
                      </div>
                      ...
                      <div class="col-span-6">
                        ...
                        <input type="number" min="1" name="lama_kursus" id="lama_kursus" value="{{ old('lama_kursus', $kursus->lama_kursus) }}"
                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md
